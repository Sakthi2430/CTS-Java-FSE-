...
Write-Host "  GitLab: https://gitlab.com/PratapSakthivel/GitRemoteDemo.git" -ForegroundColor Gray
Write-Host "  GitHub: https://github.com/PratapSakthivel/GitRemoteDemo.git" -ForegroundColor Gray
Write-Host ""
